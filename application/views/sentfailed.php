                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                  <table class="table table-bordered table-striped table-condensed" id="sentitems">
				                   <thead>
					                 <tr>
						               <th>ID</th>
						               <th>Tujuan</th>
        ...
        <script type="text/javascript">
            ...
            hapusSent = (id) => {
                if(confirm("Apakah Anda Yakin Akan Menghapus Data Ini")){
                    $.ajax({
                    url : `SentFailed/hapusSentItem/${id}`,
                    type: "POST",
                    dataType: "JSON",
            ...
            $(document).ready(function(){
                table = $('#sentitems').DataTable({
                    "processing" : true,
                    "serverSide" : true,
                    "order" : [],
                    "ajax" :{
                        "url" : "<?php echo site_url('SentFailed/ajax_list');?>",
                        "type" : "POST"
                    },
                    "columnDefs": [{
                        "targets": [ -1 ],
